...
export default function AboutPage() {
  return (
    <>
      <PageHero eyebrow="About CoNext" title="We are an open company." text="Since 2026, We've opened our doors to the world. CoNext is a Singapore-based talent and technology company focused on connecting skilled professionals, innovative teams, and global opportunities. We help create meaningful partnerships by bringing the right people, capabilities, and business needs together." />
      ...
      <section className="section section-soft"><div className="container card-grid three">
        <article className="service-card"><div className="icon-box"><GlobeIcon/></div><h3>Global by design</h3><p>Singapore is our base, while our partnership model is designed for international software markets and distributed teams.</p></article>
